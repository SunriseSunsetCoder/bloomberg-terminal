...
check("0.456 exactly → half (Q3 reverted to half 2026-08-25)", bucketForScore(0.456) === "half", bucketForScore(0.456) ?? "null");
...
check("  and the reference mirror is DERIVED from SIZE_MAP, not restated", ref.size_map.Q3 === SIZE_MAP[2] && ref.size_map.Q5 === SIZE_MAP[4] && ref.size_map.Q1 === SIZE_MAP[0]);
